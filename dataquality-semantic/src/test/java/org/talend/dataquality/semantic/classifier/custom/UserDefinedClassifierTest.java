...
public class UserDefinedClassifierTest {
    ...
    public static Map<String, String[]> TEST_DATA = new LinkedHashMap<String, String[]>() {
...

        {
            ...
            put("mailto:?to=&subject=mailto%20with%20examples&body=http://en.wikipedia.org/wiki/Mailto", new String[] {"MAIL_TO"}); //$NON-NLS-1$ //$NON-NLS-2$
            put("mailto:someone@example.com?subject=This%20is%20the%20subject", new String[] {"MAIL_TO"}); //$NON-NLS-1$ //$NON-NLS-2$
            put("mailto:p.dupond@example.com?subject=Sujet%20du%20courrier&cc=pierre@example.org&cc=jacques@example.net&body=Bonjour", new String[] {"MAIL_TO"}); //$NON-NLS-1$ //$NON-NLS-2$
            
            put("data:text/html;charset=US-ASCII,%3Ch1%3EHello!%3C%2Fh1%3E", new String[] {"DATA"}); //$NON-NLS-1$ //$NON-NLS-2$
            put("data:text/html;charset=,%3Ch1%3EHello!%3C%2Fh1%3E", new String[] {"DATA"}); //$NON-NLS-1$ //$NON-NLS-2$
            put("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAQMAAAAlPW0iAAAABlBMVEUAAAD///+l2Z/dAAAA", new String[] {"DATA"}); //$NON-NLS-1$ //$NON-NLS-2$
            put("data:,Hello World!", new String[] {"DATA"}); //$NON-NLS-1$ //$NON-NLS-2$
        }
    };
